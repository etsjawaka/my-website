...
<main>
  <section class="hero-card">
    ...
    <p class="lede">
      This page now carries the image reel, a short studio statement and the blog box so the
      planet home page can stay focused on navigation.
    </p>
  </section>
  ...
  <section class="content-grid">
    ...
    <section class="panel text-panel">
      ...
      <p>
        ...
        image-based documentation. The site is arranged like a small system of orbiting rooms so
        the work can be approached through material, process and finished objects.
      </p>
